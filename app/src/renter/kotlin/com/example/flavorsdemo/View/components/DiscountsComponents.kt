...
fun DiscountComp(discount: Discount, navController: NavHostController) {
    Card(
        modifier = Modifier
            ...
            .height(100.dp)
            .clickable {
                if (!discount.discountType.contains("Car Brand"))
                    filterFuel = discount.discountType
        ...
        Row(
            ...
            Image(
                painter = if (discount.discountType == "Electric") painterResource(id = R.drawable.electric_car)
                else if(discount.discountType == "Hybrid") painterResource(id = R.drawable.hybrid_car) else painterResource(id = R.drawable.car),
